// compile using gcc: 
// gcc -Ofast whets.c -o whets -lm -DDP -DGTODay -static
// compile using clang:
// clang -Ofast -march=native whets.c -o whets-clang -rpath /mnt/DataDisk2/dad/llvm/install/lib -static -lm -DDP -DGTODay
